...
public class GenerateStubWizardPage extends WizardPage {
			...
			public void handleEvent(Event e) {
				...
				case SWT.Selection:
					...
					if (getServiceNameText() != null) {
						...
						setPackageName("com.ejie." +  getAppName(getProjectEJB())+".remoting");
					}
					break;
				}
			}
	...
	public String getAppName(IProject project){
		String app="";
		boolean found=false;
		int contCaracter=0;
	...
	public void setProjectConfigLocation(IProject project){
		this.projectConfigLocation = Constants.PATH_CONFIG+getAppName(getProjectEJB());
